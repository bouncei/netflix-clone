// Creating Axios for HTTP requests

const requests = {
  // Insert all of the requests
  fetchTrending: `/trending/all/week?api_key=${process.env.API_KEY}&language=en-US`,
  fetchNetflixOriginals: `/discover/tv?api_key=${process.env.API_KEY}&with_network=213`,
